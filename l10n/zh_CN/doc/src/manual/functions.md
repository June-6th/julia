...
```jldoctest foofunc julia> function foo(a,b) a+b, a*b end foo (generic function with 1 method)
...
```jldoctest barfunc julia> bar(a,b,x...) = (a,b,x) bar (generic function with 1 method)
